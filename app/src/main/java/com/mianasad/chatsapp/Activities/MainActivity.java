...
public class MainActivity extends AppCompatActivity {
    public static final String FIREBASE_DATABASE_LINK = "https://uset-400719-default-rtdb.firebaseio.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirebaseRemoteConfig.fetchAndActivate().addOnSuccessListener(new OnSuccessListener<Boolean>() {
            ...
            public void onSuccess(Boolean aBoolean) {
                ...
                //getting the background image from firebase
                String backgroundImage = mFirebaseRemoteConfig.getString("backgroundImage");
                //lide supports fetching, decoding, and displaying video stills, images, and animated GIFs.
        ...
        FirebaseMessaging.getInstance()
                ...
                .addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    //updating the token of user
                    @Override
                    public void onSuccess(String token) {
                        HashMap<String, Object> map = new HashMap<>();
                        map.put("token", token);
                        //update the user list in firebase add this user under their token
        ...
        database.getReference().child("users").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1 : snapshot.getChildren()) {
                    ...
                    if (user != null && user.getUid() != null && !user.getUid().equals(FirebaseAuth.getInstance().getUid())) {
                        users.add(user);
                    }
...
//setting the status of the user wether it is online or offline
    @Override
