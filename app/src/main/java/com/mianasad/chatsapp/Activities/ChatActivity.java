...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.sendBtn.setOnClickListener(new View.OnClickListener() {
           ...
           //     Generates a new child location reference with a unique
                //     key. The push() method creates a new child node under the specified
                //     reference and assigns it a unique key. This key is generated based on a
                //     combination of timestamp and a random
