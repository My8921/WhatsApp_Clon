...
public class MessagesAdapter extends RecyclerView.Adapter {
    ...
    //creating view holder in which there is reciveing text and sending the text
    ...
    //identifying reciver message or sender message
    @Override
    public int getItemViewType(int position) {
        Message message = messages.get(position);
        //checking the message is sent by reciver or sender
